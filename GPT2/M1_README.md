...
**Note:** Your implementation needs to include the host code that launches your kernels, but you do NOT need to allocate/copy memory for the inputs/outputs. This means that you may assume memory management and copying is done properly by the provided code outside of the "`xxxx_forward()`" functions, and all you need to write in them is code that launches your kernel(s).
